this.savona || function(b) {
	...
	b.savona.client = function(a) {
		...
		c.property = new b.savona.property(c);
		c.capability = new b.savona.capability(c);
		c.process = new b.savona.process(c);
		c.system = new b.savona.system(c);
		c.clip = new b.savona.clip(c);
		c.storage = new b.savona.storage(c);
		c.button = new b.savona.button(c);
		c.notify = new b.savona.notify(c);
		c.p = new b.savona.p(c);
		c.alternate = new b.savona.alternate(c);
		c.network = new b.savona.network(c)
	};
	...
	b.savona.client.prototype.request = function(a, c) {
		var b = this,
			h = {
				method: a,
				params: []
	...
	b.savona.property.prototype.GetStatus =
		function(a) {
	...
	b.savona.property.prototype.DeleteValue =
		function(a) {
	...
	b.savona.process.prototype.GetList = function(a) {
	...
	b.savona.system.prototype.IncrementProperties = function(a) {
		return this.client.request("System.IncrementProperties", a)
	};
	b.savona.system.prototype.DecrementProperties =
		function(a) {
	...
	b.savona.system.process.prototype.AutoAdjust = function(a) {
	...
	b.savona.network = function(a) {
		this.wireless =
			new b.savona.network.wireless(a)
	};
	...
	b.savona.button.prototype.SendKeys = function(a) {
	...
	b.savona.notify.prototype.Unsubscribe =
		function(a) {
