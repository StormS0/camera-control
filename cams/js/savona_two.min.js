this.savona_two || function(b) {
	...
	b.savona_two.property.prototype.GetStatus =
		function(a) {
	...
	b.savona_two.property.prototype.DeleteValue =
		function(a) {
	...
	b.savona_two.system.settings.prototype.Load = function(a) {
		return this.client.request("System.Settings.Load",
			a)
	};
	...
	b.savona_two.system.prototype.DecrementProperties =
		function(a) {
	...
	b.savona_two.system.process.prototype.Abort = function(a) {
		return this.client.request("System.Process.Abort",
			a)
	};
	...
	b.savona_two.clip.prototype.Move =
		function(a) {
	...
	b.savona_two.clip.prototype.GetMediaProfileUrls = function(a) {
		return this.client.request("Clip.GetMediaProfileUrls",
			a)
	};
	...
	b.savona_two.clip.player.prototype.Stop = function(a) {
		return this.client.request("Clip.Player.Stop",
			a)
	};
	...
	b.savona_two.clip.player.prototype.Step = function(a) {
		return this.client.request("Clip.Player.Step",
			a)
	};
	...
	b.savona_two.network = function(a) {
		this.wireless =
			new b.savona_two.network.wireless(a)
	};
	...
	b.savona_two.notify.prototype.Unsubscribe =
		function(a) {
...
this.linear || function(b) {
	...
	b.linear.protocol.prototype.request = function() {
	...
	b.linear.protocol.plain.prototype.onmessage = function(a) {
		var b = [];
		a && b.push({
			type: "notify",
			data: {
	...
	b.linear.transport.create = function(a) {
		var b, f, h, d, j, k, m, l = {},
			e;
		for (e in a)
	...
	b.linear.transport.prototype._onopen =
		function(a) {
	...
	b.linear.transport.prototype._onclose = function(a) {
	...
	b.linear.transport.websocket = function(a) {
		var b = this;
		b.socket = a;
	...
	b.linear.transport.websocket.prototype.send = function(a) {
		this.socket.send(a)
	};
	b.linear.jsonp = {
		load: function(a, b, f) {
	...
	b.linear.transport.polling = function(a, c, f, h, d) {
		this.type = "text";
		this.url = a;
		this.channel =
			c;
	...
	b.linear.client = function(a) {
		...
		if ("function" !== typeof c) {
			...
			f = f ? f : "linear";
			try {
				c.protocol = new b.linear.protocol[f]
			} catch (j) {
				console && console.log("protocol: " + f + " is not implemented."), c.protocol = new b.linear.protocol.linear
			}
			c.transport = new b.linear.transport;
			...
			if ("[object String]" === a) {
				if (a = b.linear.transport.create({
						type: h
				...
				for (d = h.length; f < d; f++)
					if (a = "string" === typeof h[f] ? b.linear.transport.create({
							type: h[f]
						}) : b.linear.transport.create(h[f])) c.transport.entry[a.type] = a.entry, a = void 0
			} else if (void 0 !== h && "[object Object]" === a) {
				if (a = b.linear.transport.create(h)) c.transport.entry[a.type] = a.entry
			} else a = b.linear.transport.create({
				type: "websocket"
			}), c.transport.entry[a.type] = a.entry, a = b.linear.transport.create({
				type: "polling"
			}), c.transport.entry[a.type] = a.entry;
			return c
		}
	};
	b.linear.client.prototype.state =
		function() {
	...
	b.linear.client.prototype.request =
		function(a) {
			var b;
