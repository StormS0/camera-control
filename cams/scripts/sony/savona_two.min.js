this.savona_two || function(b) {
	b.savona_two = function() {};
	b.savona_two.client = function(a) {
		var c = this;
		c.version = "2.0.6";
		c.linear = new linear_two.client(a);
		...
		c.property = new b.savona_two.property(c);
		c.capability = new b.savona_two.capability(c);
		c.process = new b.savona_two.process(c);
		c.system = new b.savona_two.system(c);
		c.clip = new b.savona_two.clip(c);
		c.storage = new b.savona_two.storage(c);
		c.button = new b.savona_two.button(c);
		c.notify = new b.savona_two.notify(c);
		c.p = new b.savona_two.p(c);
		c.alternate = new b.savona_two.alternate(c);
		c.network = new b.savona_two.network(c)
	};
	b.savona_two.client.prototype.state = function() {
		return this.linear.state()
	};
	b.savona_two.client.prototype.connect = function(a) {
		return this.linear.connect(a)
	};
	b.savona_two.client.prototype.disconnect = function() {
		return this.linear.disconnect()
	};
	b.savona_two.client.prototype.request = function(a, c) {
		var b = this,
			h = {
				method: a,
				params: []
		...
		console && "undefined" !== typeof JSON && console.log("method: " + a + ", params: " + JSON.stringify(h.params));
	...
	b.savona_two.property = function(a) {
		this.client = a
	};
	b.savona_two.property.prototype.GetStatus = function(a) {
			return this.client.request("Property.GetStatus", a)
		};
	b.savona_two.property.prototype.GetValue = function(a) {
		return this.client.request("Property.GetValue", a)
	};
	b.savona_two.property.prototype.GetBackupValue = function(a) {
		return this.client.request("Property.GetBackupValue", a)
	};
	b.savona_two.property.prototype.SetValue = function(a) {
		return this.client.request("Property.SetValue", a)
	};
	b.savona_two.property.prototype.AddValue = function(a) {
		return this.client.request("Property.AddValue", a)
	};
	b.savona_two.property.prototype.DeleteValue = function(a) {
			return this.client.request("Property.DeleteValue", a)
		};
	b.savona_two.property.prototype.UpdateValue = function(a) {
		return this.client.request("Property.UpdateValue", a)
	};
	b.savona_two.property.prototype.GetRequestInterval = function(a) {
		return this.client.request("Property.GetRequestInterval", a)
	};
	b.savona_two.capability = function(a) {
		this.client = a
	};
	b.savona_two.capability.prototype.GetValue = function(a) {
		return this.client.request("Capability.GetValue", a)
	};
	b.savona_two.process = function(a) {
		this.client = a;
		this.execute = new b.savona_two.process.execute(a)
	};
	b.savona_two.process.prototype.GetList = function(a) {
		return this.client.request("Process.GetList", a)
	};
	b.savona_two.process.prototype.Abort = function(a) {
		return this.client.request("Process.Abort", a)
	};
	b.savona_two.process.execute = function(a) {
		this.client = a
	};
	b.savona_two.process.execute.prototype.AutomaticAdjustment = function(a) {
		return this.client.request("Process.Execute.AutomaticAdjustment", a)
	};
	b.savona_two.process.execute.prototype.Reacquisition = function(a) {
		return this.client.request("Process.Execute.Reacquisition", a)
	};
	b.savona_two.system = function(a) {
			this.client = a;
			this.firmware = new b.savona_two.system.firmware(a);
			this.settings = new b.savona_two.system.settings(a);
			this.logs = new b.savona_two.system.logs(a);
			this.process = new b.savona_two.system.process(a)
		};
	b.savona_two.system.prototype.Reboot = function(a) {
		return this.client.request("System.Reboot", a)
	};
	b.savona_two.system.prototype.Shutdown = function(a) {
		return this.client.request("System.Shutdown", a)
	};
	b.savona_two.system.prototype.FactoryReset = function(a) {
		return this.client.request("System.FactoryReset", a)
	};
	b.savona_two.system.firmware = function(a) {
			this.client = a
		};
	b.savona_two.system.firmware.prototype.Update = function(a) {
		return this.client.request("System.Firmware.Update", a)
	};
	b.savona_two.system.settings = function(a) {
		this.client = a
	};
	b.savona_two.system.settings.prototype.Reset = function(a) {
		return this.client.request("System.Settings.Reset", a)
	};
	b.savona_two.system.settings.prototype.Save = function(a) {
		return this.client.request("System.Settings.Save", a)
	};
	b.savona_two.system.settings.prototype.Load = function(a) {
		return this.client.request("System.Settings.Load", a)
	};
	b.savona_two.system.logs = function(a) {
		this.client = a
	};
	b.savona_two.system.logs.prototype.Save = function(a) {
		return this.client.request("System.Logs.Save", a)
	};
	b.savona_two.system.prototype.GetProperties = function(a) {
		return this.client.request("System.GetProperties", a)
	};
	b.savona_two.system.prototype.SetProperties = function(a) {
		return this.client.request("System.SetProperties", a)
	};
	b.savona_two.system.prototype.IncrementProperties = function(a) {
		return this.client.request("System.IncrementProperties", a)
	};
	b.savona_two.system.prototype.DecrementProperties = function(a) {
			return this.client.request("System.DecrementProperties", a)
		};
	b.savona_two.system.prototype.GetCapabilities = function(a) {
		return this.client.request("System.GetCapabilities", a)
	};
	b.savona_two.system.process = function(a) {
		this.client = a
	};
	b.savona_two.system.process.prototype.GetList = function(a) {
		return this.client.request("System.Process.GetList", a)
	};
	b.savona_two.system.process.prototype.AutoAdjust = function(a) {
		return this.client.request("System.Process.AutoAdjust", a)
	};
	b.savona_two.system.process.prototype.Abort = function(a) {
		return this.client.request("System.Process.Abort", a)
	};
	b.savona_two.clip = function(a) {
		this.client = a;
		this.player = new b.savona_two.clip.player(a);
		this.recorder = new b.savona_two.clip.recorder(a)
	};
	b.savona_two.clip.prototype.GetList = function(a) {
		return this.client.request("Clip.GetList", a)
	};
	b.savona_two.clip.prototype.GetThumbnailUrls = function(a) {
		return this.client.request("Clip.GetThumbnailUrls", a)
	};
	b.savona_two.clip.prototype.Copy = function(a) {
		return this.client.request("Clip.Copy", a)
	};
	b.savona_two.clip.prototype.Rename = function(a) {
		return this.client.request("Clip.Rename", a)
	};
	b.savona_two.clip.prototype.Move = function(a) {
			return this.client.request("Clip.Move", a)
		};
	b.savona_two.clip.prototype.Delete = function(a) {
		return this.client.request("Clip.Delete", a)
	};
	b.savona_two.clip.prototype.Upload = function(a) {
		return this.client.request("Clip.Upload", a)
	};
	b.savona_two.clip.prototype.UploadFiles = function(a) {
		return this.client.request("Clip.UploadFiles", a)
	};
	b.savona_two.clip.prototype.Download = function(a) {
		return this.client.request("Clip.Download", a)
	};
	b.savona_two.clip.prototype.GetMediaProfileUrls = function(a) {
		return this.client.request("Clip.GetMediaProfileUrls", a)
	};
	b.savona_two.clip.player = function(a) {
		this.client = a
	};
	b.savona_two.clip.player.prototype.Open = function(a) {
		return this.client.request("Clip.Player.Open", a)
	};
	b.savona_two.clip.player.prototype.GotoClip = function(a) {
		return this.client.request("Clip.Player.GotoClip", a)
	};
	b.savona_two.clip.player.prototype.Close = function(a) {
		return this.client.request("Clip.Player.Close", a)
	};
	b.savona_two.clip.player.prototype.Start = function(a) {
		return this.client.request("Clip.Player.Start", a)
	};
	b.savona_two.clip.player.prototype.Stop = function(a) {
		return this.client.request("Clip.Player.Stop", a)
	};
	b.savona_two.clip.player.prototype.Pause = function(a) {
		return this.client.request("Clip.Player.Pause", a)
	};
	b.savona_two.clip.player.prototype.FastForward = function(a) {
		return this.client.request("Clip.Player.FastForward", a)
	};
	b.savona_two.clip.player.prototype.Rewind = function(a) {
		return this.client.request("Clip.Player.Rewind", a)
	};
	b.savona_two.clip.player.prototype.Shuttle = function(a) {
		return this.client.request("Clip.Player.Shuttle", a)
	};
	b.savona_two.clip.player.prototype.Step = function(a) {
		return this.client.request("Clip.Player.Step", a)
	};
	b.savona_two.clip.recorder = function(a) {
		this.client = a
	};
	b.savona_two.clip.recorder.prototype.Open = function(a) {
		return this.client.request("Clip.Recorder.Open", a)
	};
	b.savona_two.clip.recorder.prototype.Close = function(a) {
		return this.client.request("Clip.Recorder.Close", a)
	};
	b.savona_two.clip.recorder.prototype.Start = function(a) {
		return this.client.request("Clip.Recorder.Start", a)
	};
	b.savona_two.clip.recorder.prototype.Stop = function(a) {
		return this.client.request("Clip.Recorder.Stop", a)
	};
	b.savona_two.network = function(a) {
		this.wireless = new b.savona_two.network.wireless(a)
	};
	b.savona_two.network.wireless = function(a) {
		this.wps = new b.savona_two.network.wireless.wps(a)
	};
	b.savona_two.network.wireless.wps = function(a) {
		this.client = a
	};
	b.savona_two.network.wireless.wps.prototype.Start = function(a) {
		return this.client.request("Network.Wireless.WPS.Start", a)
	};
	b.savona_two.storage = function(a) {
		this.drive = new b.savona_two.storage.drive(a)
	};
	b.savona_two.storage.drive = function(a) {
		this.client = a
	};
	b.savona_two.storage.drive.prototype.Format = function(a) {
		return this.client.request("Storage.Drive.Format",
			a)
	};
	b.savona_two.storage.drive.prototype.Eject = function(a) {
		return this.client.request("Storage.Drive.Eject", a)
	};
	b.savona_two.storage.drive.prototype.Finalize = function(a) {
		return this.client.request("Storage.Drive.Finalize", a)
	};
	b.savona_two.button = function(a) {
		this.client = a
	};
	b.savona_two.button.prototype.SendKeys = function(a) {
		return this.client.request("Button.SendKeys", a)
	};
	b.savona_two.notify = function(a) {
		this.client = a
	};
	b.savona_two.notify.prototype.Subscribe = function(a) {
		return this.client.request("Notify.Subscribe", a)
	};
	b.savona_two.notify.prototype.Unsubscribe = function(a) {
			return this.client.request("Notify.Unsubscribe", a)
		};
	b.savona_two.p = function(a) {
		this.process = new b.savona_two.p.process(a)
	};
	b.savona_two.p.process = function(a) {
		this.client = a
	};
	b.savona_two.p.process.prototype.Execute = function(a) {
		return this.client.request("P.Process.Execute", a)
	};
	b.savona_two.alternate = function(a) {
		this.authentication = new b.savona_two.alternate.authentication(a)
	};
	b.savona_two.alternate.authentication = function(a) {
		this.client = a
	};
	b.savona_two.alternate.authentication.prototype.Basic = function(a) {
		return this.client.request("Alternate.Authentication.Basic",
			a)
	}
}(this);
/*
 Copyright 2013 Sony Corp.
*/
this.linear_two || function(b) {
	b.linear_two = function() {};
	b.linear_two.todouble = function(a) {
		return new msgpack_two.todouble(a)
	};
	b.linear_two.base64 = function() {
		var a = function(a) {
	...
	b.linear_two.btoa = function(a) {
		var c = b.btoa || b.linear.base64.encode;
		if ("string" !== typeof a) throw "INVALID_CHARACTER_ERR";
		return c(a)
	};
	b.linear_two.atob = function(a) {
		var c = b.atob || b.linear.base64.decode;
		if ("string" !== typeof a) throw "INVALID_CHARACTER_ERR";
		return c(a)
	};
	b.linear_two.extend = function(a, b) {
		var f = new a;
		if (!b) return f;
		for (var h in b) f[h] !== b[h] && (f[h] = b[h]);
		return f
	};
	b.linear_two.codec = function() {
		this.type = void 0
	};
	b.linear_two.codec.prototype.encode = function(a) {
		return a
	};
	b.linear_two.codec.prototype.decode = function(a) {
		return a
	};
	b.linear_two.codec.prototype.refresh = function() {};
	b.linear_two.codec.plain = function() {
			this.type = "plain";
			return b.linear.extend(b.linear.codec, this)
		};
	b.linear_two.codec.msgpack_two = function() {
		this.type = "msgpack";
		this.unpacker = new msgpack_two.unpacker;
		return b.linear.extend(b.linear.codec, this)
	};
	b.linear_two.codec.msgpack_two.prototype.encode = function(a) {
		return msgpack_two.pack(a)
	};
	b.linear_two.codec.msgpack_two.prototype.decode = function(a) {
		var b = [];
		for (this.unpacker.feed(a); void 0 !== (a = this.unpacker.unpack());) b.push(a);
		return b
	};
	b.linear_two.codec.msgpack_two.prototype.refresh = function() {
		this.unpacker.refresh()
	};

	b.linear_two.protocol = function() {
		this.codec = this.type = void 0
	};
	b.linear_two.protocol.prototype.request = function() {
		throw Error("method is not allowed");
	};
	b.linear_two.protocol.prototype.response = function() {
		throw Error("method is not allowed");
	};
	b.linear_two.protocol.prototype.notify = function() {
		throw Error("method is not allowed");
	};
	b.linear_two.protocol.prototype.onmessage = function(a) {
		return a
	};
	b.linear_two.protocol.prototype.reset = function() {};
	b.linear_two.protocol.plain = function() {
		this.type = "plain";
		this.codec = new linear.codec.plain;
		return b.linear.extend(b.linear.protocol, this)
	};
	b.linear_two.protocol.plain.prototype.onmessage = function(a) {
		var b = [];
		a && b.push({
			type: "notify",
			data: {
	...
	b.linear_two.protocol.linear = function() {
		this.type = "linear";
		this.msgid = 0;
		this.codec = new b.linear_two.codec.msgpack_two;
		this.requests = {};
		return b.linear_two.extend(b.linear_two.protocol, this)
	};
	b.linear_two.protocol.linear.prototype.request = function(a) {
		var b = this,
			f = {},
			h;
	...
	b.linear_two.protocol.linear.prototype.notify = function(a) {
	...
	b.linear_two.protocol.linear.prototype.ontimeout = function(a) {
	...
	b.linear_two.protocol.linear.prototype.onmessage = function(a) {
	...
	b.linear_two.protocol.linear.prototype.reset = function() {
		this.codec.refresh()
	};

	b.linear_two.transport = function() {
		this.state = "disconnected";
		this.sendbuffer = [];
		this.num2bin = {};
		for (var a = 0; 256 > a; ++a) this.num2bin[a] = String.fromCharCode(a)
	};
	b.linear_two.transport.create = function(a) {
		var b, f, h, d, j, k, m, l = {},
			e;
		for (e in a)
	...
	b.linear_two.transport.prototype.connect = function(a) {
		function c() {
			d.type = "websocket";
			d.raw = new b.linear.transport.websocket(h);
		...
		function f() {
			h = void 0;
			d.entry.polling ? (d.type = "polling", d.raw = new b.linear.transport.polling(d.entry.polling.url, d.entry.polling.channel, d.entry.polling.options, function() {
				d._onopen()
			}, function() {
				d._onclose()
			}), d.raw.onopen = function(a) {
		...
		if (!("connecting" === d.state || "connected" ===
			...
			if (d.state = "connecting", a = a && a.timeout ? a.timeout : 3E4, d.entry.websocket) {
				try {
					...
					d.type = "polling";
					d.raw = new b.linear.transport.polling(
						d.entry.polling.url,
			...
			} else d.entry.polling ? (d.type = "polling", d.raw = new b.linear.transport.polling(d.entry.polling.url, d.entry.polling.channel, d.entry.polling.options, function() {
				d._onopen()
			}, function() {
				d._onclose()
			}), d.raw.onopen = function(a) {
	...
	b.linear_two.transport.prototype._onopen = function(a) {
			...
			if ("connecting" === this.state) this.sendbuffer[this.sendbuffer.length] = a;
				...
				if ("[object String]" === f) c = a;
					...
					if ("text" === this.raw.type) {
						...
						c = b.linear.btoa(c.join(""))
					} else "binary" === this.raw.type && (c = (new Uint8Array(a)).buffer);
				else return;
				this.raw.send(c)
			}
	};
	b.linear_two.transport.websocket = function(a) {
		var b = this;
		b.socket = a;
	...
	b.linear_two.transport.websocket.prototype.disconnect = function() {
		this.socket.close()
	};
	b.linear_two.transport.websocket.prototype.send = function(a) {
		this.socket.send(a)
	};
	b.linear_two.jsonp = {
		load: function(a, b, f) {
	...
	b.linear_two.transport.polling = function(a, c, f, h, d) {
		this.type = "text";
		this.url = a;
		this.channel =
			c;
		...
		j.state = "connecting";
		b.linear.jsonp.load(this.url + k, function(a) {
			j.sid = a.sid;
			"connecting" !== j.state ? (k = "?c=disconnect&sid=" + j.sid, b.linear.jsonp.load(j.url + k)) : (j.dopoll(), "function" === typeof h && h())
		}, d)
	};
	b.linear_two.transport.polling.prototype.disconnect = function() {
		...
		if ("disconnecting" !== this.state && (this.state = "disconnecting", this.intervaltimer && clearTimeout(this.intervaltimer),
				this.seq = this.intervaltimer = 0, void 0 !== this.sid && b.linear.jsonp.load(this.url + a), this.sid = void 0, "function" === typeof this.onclose)) this.onclose()
	};
	b.linear_two.transport.polling.prototype.send = function(a) {
		function b(a, d) {
			if (d.confirmed) try {
	...
	b.linear_two.transport.polling.prototype.dopoll = function() {
		function a(a) {
		...
		void 0 === this.sid || "disconnecting" === this.state || (h = f.options ? f.options.interval || 250 : 250, b.linear.jsonp.load(this.url + d, a, c))
	};
	b.linear_two.client = function(a) {
		var c = this,
			f, h;
		c.version = "2.0.6";
		if ("function" !== typeof c) {
			...
			f = f ? f : "linear";
			try {
				c.protocol = new b.linear_two.protocol[f]
			} catch (j) {
				console && console.log("protocol: " + f + " is not implemented."), c.protocol = new b.linear_two.protocol.linear
			}
			c.transport = new b.linear_two.transport;
			...
			if ("[object String]" === a) {
				if (a = b.linear_two.transport.create({
						type: h
				...
				for (d = h.length; f < d; f++)
					if (a = "string" === typeof h[f] ? b.linear_two.transport.create({
							type: h[f]
						}) : b.linear_two.transport.create(h[f])) c.transport.entry[a.type] = a.entry, a = void 0
			} else if (void 0 !== h && "[object Object]" === a) {
				if (a = b.linear_two.transport.create(h)) c.transport.entry[a.type] = a.entry
			} else a = b.linear_two.transport.create({
				type: "websocket"
			}), c.transport.entry[a.type] = a.entry, a = b.linear_two.transport.create({
				type: "polling"
			}), c.transport.entry[a.type] = a.entry;
			return c
		}
	};
	b.linear_two.client.prototype.state = function() {
			return this.transport.state
		};
	b.linear_two.client.prototype.connect = function(a) {
		"function" === typeof this.transport.connect && this.transport.connect(a)
	};
	b.linear_two.client.prototype.onconnect = function(a) {
		"function" === typeof a && (this.onconnect = a)
	};
	b.linear_two.client.prototype.disconnect = function() {
		"function" === typeof this.transport.disconnect && this.transport.disconnect()
	};
	b.linear_two.client.prototype.ondisconnect = function(a) {
		"function" === typeof a && (this.ondisconnect = a)
	};
	b.linear_two.client.prototype.request = function(a) {
			var b;
	...
	b.linear_two.client.prototype.onresponse = function(a) {
		"function" === typeof a && (this.onresponse = a)
	};
	b.linear_two.client.prototype.notify = function(a) {
		var b;
	...
	b.linear_two.client.prototype.onnotify = function(a) {
		"function" === typeof a && (this.onnotify = a)
	};
	b.linear_two.client.prototype._onopen = function() {
		var a;
	...
	b.linear_two.client.prototype._onclose = function() {
		var a;
		this.protocol.reset();
	...
	b.linear_two.client.prototype._onmessage = function(a) {
